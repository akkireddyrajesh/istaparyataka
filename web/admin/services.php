...
<body class="page-header-fixed page-sidebar-fixed">
                  ...
                  <div class="tab-content">
                     ...
                     <div class="tab-pane active" id="tab_1">
                        <div class="portlet box blue">
                           <div class="portlet-title">
                              <div class="caption"><i class="icon-reorder"></i>Our Contacts</div>
                              <div class="tools">
				     ...
				     <form action=""  class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-actions fluid">
                           <div class="col-md-offset-3 col-md-9">
                              <!--<button type="submit" class="btn green" name="services" onClick="edit1()">Submit</button>-->
                     ...
                     <div class="tab-pane " id="tab_2">
                        <div class="portlet box green">
                           <div class="portlet-title">
                              <div class="caption"><i class="icon-reorder"></i>Our Services</div>
                              <div class="tools">
                                 <a href="javascript:;" class="collapse"></a>
 ...
 <table class="table table-striped table-bordered table-hover" id="sample_1">
						   ...
						   while($show=mysqli_fetch_assoc($result))
	{
        ...
        <td ><?php echo substr($show['message'], 0, 100); ?></td>
        <td ><?php echo $show['email'] ?></td>
        <td ><?php echo $show['phone'] ?></td>
   

   <td><a href = "delete.php?type=services&id=<?php echo $show['id']; ?>" class="btn btn-xs blue"><i class="icon-remove"></i></a></td>
        </tr>
    <?php
	$s++;
    }
